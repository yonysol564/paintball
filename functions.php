...
******************************************************************************************/
	function register_my_jscripts() {
	   ...
	   wp_register_script( 'slick', THEME_DIR.'/js/slick.js', array( 'jquery' ), '1', true ); wp_enqueue_script( 'slick' );
	  ...
	  wp_register_script( 'googleapi', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBkpt2kWZpqWUPMuimBA1B6EVIszjRb5_s', array( 'jquery' ), null, false );
...
function register_my_menu() {
    ...
    register_nav_menus(array(
    	...
    	'copy_menu_footer'  =>  'Copy Menu Footer',
...
******************************************************************************************/
	...
	function my_acf_init() {
	 ...
	 acf_update_setting('google_api_key', 'AIzaSyBkpt2kWZpqWUPMuimBA1B6EVIszjRb5_s');
	}
